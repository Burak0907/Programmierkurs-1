...
public class RisikoverwaltungTypsichereCollection {
    ...
    public void zeigeRisiko(){
        ...
        list.stream().sorted((a,b)->Float.compare(a.berechneRisikowert(), b.berechneRisikowert())).forEach(risiko -> risiko.druckeDaten(System.out));;
        /* 
    ...
    public void sucheRisikoMitMaxRueckstellung(){
        ...
        list.get(nummer).druckeDaten(System.out);
    }
